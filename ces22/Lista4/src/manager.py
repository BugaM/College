...
class ClientManager(Manager):
    '''
    Class that manages client related operations
    '''
...
class BookManager(Manager):
    '''
    Class that manages book related operations
    '''
    ...
    def add(self, title, author, genre, edition, publisher, sell_price, buy_price):
        book = Book(title, author, genre, edition,
...
class AuthorManager(Manager):
    '''
    Class that manages author related operations
    '''
...
class BookOrderManager(Manager):
    '''
    Class that manages book order related operations
    '''
